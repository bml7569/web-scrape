...
public class Analytics {
    ...
    public HashMap<String, Integer> countWords() {
        if (memoizedOperations.containsKey("count.words"))
            return (HashMap<String, Integer>) memoizedOperations.get("count.words");
    ...
    public HashMap<String, Double> wordFrequency() {
        if (memoizedOperations.containsKey("word.frequency"))
            return (HashMap<String, Double>) memoizedOperations.get("word.frequency");
